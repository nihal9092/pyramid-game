...
function createGiftMessage(message) {
  ...
  text.innerHTML = `
    ...
    <span class="font-bold text-yellow-300">${sanitizeText(message.giftName)}</span>
...
function cleanupChat() {
  ChatState.unsubscribers.forEach(unsub => {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { initChat, cleanupChat, openGiftModal, closeGiftModal };
}

console.log('✅ chat.js fully loaded — openGiftModal is ready');
